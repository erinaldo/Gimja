            ...
            using (var db = new eDMSEntity("eDMSEntity"))
            {
                try
                {
                    var _receivedItems = (from r in db.Receipts
                                          ...
                                          where !string.IsNullOrEmpty(r.approvedBy) && !(r.isDeleted ?? false) && !(ri.isDeleted ?? false)
                                          select new
                                          {
                                              ItemId = ri.itemID,
                    ...
                    var _issuedItems = (from i in db.Issuances
                                        ...
                                        where !string.IsNullOrEmpty(i.approvedBy) && !(i.isDeleted ?? false) && !(ii.isDeleted ?? false)
                                        select new
                                        {
                                            ItemId = ii.itemID,
                    ...
                    var _soldItems = (from s in db.Sales
                                      ...
                                      where !(s.isVoid ?? false) && !(sd.isDeleted ?? false) &&
